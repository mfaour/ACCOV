...
/*
    - Nombre des threads est 3, le main thread + 2 threads cree.
    - Nombre d'incrementation de la variable _cpt est 100000 par chaque thread
    - Valeur affiche' est variable 
    - Resultat sera variable car _cpt est une variable partagée entre les differents threads
*/
